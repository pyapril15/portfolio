...
const Projects = () => {
    ...
    const defaultProjectImage = 'https://readdy.ai/api/search-image?query=$%7Bproject.image%7D&width=400&height=300&seq=home-project-0&orientation=landscape';
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        {filteredProjects.map((project, index) => (
                            ...
                            >
                                <GlassCard className="cursor-pointer group bg-[#1a1a3a]/50 backdrop-blur-sm rounded-2xl overflow-hidden border border-[#00e5ff]/20 hover:border-[#00e5ff]/40 transition-all duration-300">
