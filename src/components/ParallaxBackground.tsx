...
const FloatingCSSParticles = () => {
    const particles = useMemo(() => {
        return Array.from({ length: 60 }, (_, i) => ({
            ...
            delay: Math.random() * 8,
            color: i % 4 === 0 ? 'from-purple-400/30 to-pink-400/30' :
                i % 4 === 1 ? 'from-blue-400/30 to-cyan-400/30' :
                    i % 4 === 2 ? 'from-pink-400/30 to-purple-400/30' :
...
const ParallaxBackground = () => {
    ...
    useEffect(() => {
        ...
        // Delayed canvas loading for better performance
    ...
    return (
        <div className="absolute inset-0">
            {/* Primary Background Gradient - Always consistent */}
            ...
            {/* CSS Floating Particles - Reduced if motion is disabled */}
            {!reducedMotion && <FloatingCSSParticles />}

            {/* Enhanced 3D Canvas - Only if motion is enabled and canvas is loaded */}
            {canvasLoaded && !reducedMotion && (
                <div className="absolute inset-0">
                    <Canvas
                    ...
                    >
                        ...
                        {/* Particle systems */}
                        <EnhancedParticleSystem count={2500} />
